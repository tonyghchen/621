...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setNeedleColorOnDrag(255, 0, 0, 255)  # 移動時指針顏色
...
#            __file__), 'fonts/Orbitron/Orbitron-VariableFont_wght.ttf'))
        ...
        self.initial_scale_fontsize = 13    # 儀表盤數值
        ...
        #self.value_fontname = "Ariel"
        self.initial_value_fontsize = 20        # 儀表指針數值
        self.value_fontsize = self.initial_value_fontsize
        self.text_radius_factor = 0.6
        ...
        ################################################################################################
        self.needle_scale_factor = 1    # 指針長度
        ################################################################################################
        # ENABLE NEEDLE POLYGON BY DEFAULT
        ################################################################################################
        self.enable_Needle_Polygon = True   # 指針顯示 True
...
#            ]
    ...
    def rescale_method(self):
        ...
        self.scale_fontsize = int(
            self.initial_scale_fontsize * self.widget_diameter / 400) #設定框大小
    ...
    def updateValue(self, value, mouse_controlled=False):
        ...
        #     self.value = value
        #
        # if mouse_controlled:valueChanged
    ...
    def mouseMoveEvent(self, event):
        ...
        #print("Mouse Move X", str(event.x()))
